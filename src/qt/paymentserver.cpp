...
const QString BITCOIN_IPC_PREFIX("interstellarholdings:");
...
{
    QString name("InterstellarHoldingsQt");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start interstellarholdings: click-to-pay handler");
    else
